...
export const publicNavigation: NavigationLink[] = [
  ...
  { href: '/case-studies', label: 'งานคดี', labelEn: 'Case Work' },
...
// แผนใหม่: แยก Information (MainMenu) และ Action (QuickActions)
export const mainMenu: NavigationLink[] = [
  publicNavigation[2], // Services
  teamNavigationLink,   // Team
  publicNavigation[3], // Knowledge
  publicNavigation[5], // Case Studies
]

export const quickActions: NavigationLink[] = [
  { href: '/consultation', label: 'นัดหมายปรึกษา', labelEn: 'Book Consultation' },
  publicNavigation[6], // Process
  publicNavigation[7], // Contact
  { href: '/office', label: 'ที่ตั้งสำนักงาน', labelEn: 'Office Location' },
]
...
export const headerNavigation: NavigationLink[] = [
  ...
  { href: '/case-studies', label: 'งานคดี', labelEn: 'Cases' },
  { href: '/team', label: 'ทีมงาน', labelEn: 'Team' },
  { href: '/articles', label: 'กฎหมายน่ารู้', labelEn: 'Articles' },
  { href: '/consultation', label: 'FAQ', labelEn: 'FAQ' },
  { href: '/contact', label: 'ติดต่อเรา', labelEn: 'Contact' },
]
...
export const serviceMenuGroups: ServiceMenuGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'คดีทุจริตและประพฤติมิชอบ', labelEn: 'Anti-Corruption Cases', href: '/services/anti-corruption' },
  ...
  },
  {
    ...
    titleEn: 'Advisory, Documents & Foreign Matters',
    description:
    ...
    links: [
      ...
      { label: 'บริการด้านภาษี', labelEn: 'Tax Services', href: '/services/tax' },
      {
        label: 'บริการด้านวีซ่าและเอกสารต่างประเทศ',
        labelEn: 'Visa & Foreign Document Services',
        href: '/services/visa-foreign-documents',
      },
    ],
  },
  {
...
export const articleMenuGroups: NavigationMenuGroup[] = [
  {
    title: 'หมวดบทความ',
    titleEn: 'Article Categories',
    links: [
      { label: 'กฎหมายแพ่ง', labelEn: 'Civil Law', href: '/articles?category=civil' },
      { label: 'กฎหมายอาญา', labelEn: 'Criminal Law', href: '/articles?category=criminal' },
      { label: 'กฎหมายครอบครัว', labelEn: 'Family Law', href: '/articles?category=family' },
      { label: 'กฎหมายมรดก', labelEn: 'Inheritance Law', href: '/articles?category=inheritance' },
      { label: 'กฎหมายที่ดิน', labelEn: 'Land Law', href: '/articles?category=land' },
    ],
  },
  {
    title: 'คู่มือประชาชน',
    titleEn: 'Public Guides',
    links: [
      { label: 'คู่มือว่าจ้างทนาย', labelEn: 'Guide to Hiring a Lawyer', href: '/articles?category=lawyer-guide' },
      { label: 'สัญญาและธุรกิจ', labelEn: 'Contracts and Business', href: '/articles?category=contracts' },
      { label: 'กฎหมายเช็ค', labelEn: 'Cheque Law', href: '/articles?category=cheque' },
      { label: 'กฎหมายแรงงาน', labelEn: 'Labor Law', href: '/articles?category=labor' },
    ],
  },
]
