  ...
  return (
    <main>
      <PageHero
        ...
        description="ค้นหาหัวข้อจากฐานบทความ หรือเลือกดูหมวดบริการกฎหมายของสำนักงาน"
      ...
      <section className="py-14 md:py-20">
        <Container className="max-w-4xl">
          ...
          <div className="mt-8 grid gap-5 sm:grid-cols-2">
            <Link href="/legal-knowledge" className="group rounded-2xl border border-border bg-card p-6 shadow-sm">
            ...
            <Link href="/services" className="group rounded-2xl border border-border bg-card p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm leading-7 text-muted-foreground">
                เลือกบริการตามประเภทคดี สัญญา บังคับคดี และงานทะเบียนธุรกิจ
              </p>
              <span className="mt-4 inline-flex items-center gap-2 text-sm font-bold text-primary">
                ดูบริการทั้งหมด
                <ArrowRight className="size-4 transition group-hover:translate-x-1" aria-hidden="true" />
